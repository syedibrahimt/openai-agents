...
export const closerAgent = new RealtimeAgent({
  ...
  instructions: `Congratulate the student for successfully completing all the steps of the problem. Inform them that the final answer to the problem "${problemData.problem}" is: ${problemData.steps[problemData.steps.length - 1].notes.updated_expression}. Encourage them to keep practicing and let them know they did a great job!`
});